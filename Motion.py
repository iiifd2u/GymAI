...
def compare_with(master:Motion, trial:Motion):
    ...
    # alpha = 0.3
    #
    # mask_trial = np.vstack([trial.masks[:, 0] - box[0], mask_real[:, 1] - box[1]]).T
...
if __name__ == '__main__':
    ...
    compare_with(master=masterflip, trial=masterflip)
